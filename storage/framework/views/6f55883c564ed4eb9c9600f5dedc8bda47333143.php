                        ...
                        <table class="table table-bordered">
                            ...
                            foreach ($__currentLoopData as $index => $banner): $__env->incrementLoopIndices();
                                ...
                                <tr>
                                    ...
                                    <td style="height: 100px; width: 150px;"><img
                                                src="<?php echo e(asset($banner->image)); ?>"

                                                class="img" style="height: 100%;">

                                    </td>

                                    <td class="banner"><?php echo e($banner->title); ?></td>

                                    <td class="banner"><?php echo e($banner->discount); ?></td>

                                    <td class="banner"><?php echo e($banner->sub_title); ?></td>
