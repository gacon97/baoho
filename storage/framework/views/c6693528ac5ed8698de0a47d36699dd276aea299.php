<script type="text/javascript" src="<?php echo e(asset('web/js/jquery-2.1.4.min.js')); ?>"></script>

<!-- //js -->

<script src="<?php echo e(asset('web/js/modernizr.custom.js')); ?>"></script>
        ...
        methods: {
            searchComplete: function () {
                if (this.keySearch.length > 1) {
                    ...
                    axios.get('/search-complete/' + this.keySearch)
                        .then(function (response) {
                            console.log(response.data);
                            this.productSearch.set(response.data);
                        })
...
<script>
    var item = {
        ...
        template: `
            <div class="col-md-3 search-box-product-img">
                <img :src="image" class="search-box-img">
            </div>
            <div class="col-md-9">
                <div>
                    <span>{{name}}</span>
...
<script type="text/javascript">
    ...
    var app = new Vue({
        ...
        data: {
            ...
            list: <?php echo json_encode($products, JSON_NUMERIC_CHECK) ?>,
...
<script src="<?php echo e(asset('web/js/easy-responsive-tabs.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('web/js/jquery.easing.min.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('web/js/bootstrap.js')); ?>"></script>

<script type="text/javascript" src="<?php echo e(asset('web/js/popper.min.js')); ?>"></script>

<!-- <script type="text/javascript" src="<?php echo e(asset('web/js/jquery-ui.js')); ?>"></script> -->

<script type="text/javascript" src="<?php echo e(asset('web/js/jquery.flexslider.js')); ?>"></script>
