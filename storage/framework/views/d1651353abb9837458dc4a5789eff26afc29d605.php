                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"
                                        ...
                                        <div class="checkbox form-check form-check-inline">
                                            ...
                                            <label>
                                                ...
                                                <input type="checkbox" class="flat" value="<?php echo e($color->id); ?>"
                                                       ...
                                                       name="color[]" <?php $__currentLoopData = $product->colors;
                                                $__env->addLoop($__currentLoopData);
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Chất liệu</label>

                                <div class="col-md-6 col-sm-6 col-xs-12">

                                    <input id="tags_1" type="text" class="tags form-control"
                                           value="<?php echo e(old('material', isset($product) ? $product->material : null)); ?>"
                                           name="materials"/>
                                        ...
                                        <div class="checkbox form-check form-check-inline">
                                            ...
                                            <label>
                                                ...
                                                <input type="checkbox" class="flat" value="<?php echo e($size->id); ?>"
                                                       ...
                                                       name="size[]" <?php $__currentLoopData = $product->sizes;
                                                $__env->addLoop($__currentLoopData);
                                                ...
                                                <?php endforeach;
                                                $__env->popLoop();
                                                $loop = $__env->getLastLoop(); ?>> <?php echo e($size->size); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" id="last-name"
                                           ...
                                           value="<?php echo e(old('discount', isset($product->discount) ? $product->discount : null)); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text"
                                           ...
                                           value="<?php echo e(old('link_video', isset($product) ? $product->link_video : null)); ?>">
